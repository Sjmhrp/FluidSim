...
public class Vector4d implements Serializable{
	...
	public static Vector4d cross(Vector4d u, Vector4d v, Vector4d w) {
		...
		return new Vector4d(u.y*f-u.z*e+u.w*d,-u.x*f+u.z*c-u.w*b,u.x*e-u.y*c+u.w*a,-u.x*d+u.y*b-u.z*a);
	}
